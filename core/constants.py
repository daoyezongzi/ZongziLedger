...
DEFAULT_CAPTURE_BACKEND = "wetrace_api"
...
DEFAULT_DIFY_REMOTE_FALLBACK_LOCAL = False
...
DEFAULT_KNOWN_STORE_LOOKUP_PATH = "dictionaries/known_stores.local.json"
DEFAULT_KNOWN_STORE_LOOKUP_MAX_MATCHES = 3

DEFAULT_VISION_ENABLED = False
DEFAULT_VISION_INBOX_DIR = "data/vision_inbox"
DEFAULT_VISION_STATE_PATH = "data/vision_ingest_state.local.json"
DEFAULT_VISION_REVIEW_QUEUE_PATH = "data/review_queue.local.jsonl"
DEFAULT_VISION_OCR_PROVIDER = "tesseract"
DEFAULT_VISION_IMAGE_EXTENSIONS = [".png", ".jpg", ".jpeg", ".webp", ".bmp"]
DEFAULT_VISION_MAX_IMAGES_PER_RUN = 50
